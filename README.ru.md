...
- **CastBoard** — Превратите другое устройство в экран состояния компьютера в реальном времени. Он передает информацию о треке, обложку альбома и синхронизированные тексты песен в реальном времени, поддерживая NetEase Cloud Music, QQ Music, Sogou Music и Spotify. Также синхронизирует показатели использования CPU, памяти, сети и других ресурсов компьютера. В дальнейшем появятся новые функции.
...
3. Начните синхронизировать буфер обмена, отправлять файлы или транслировать CastBoard.
